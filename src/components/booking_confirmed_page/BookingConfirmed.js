    ...
    <div className={`${style.page} container pb-3`}>
      <div className="text-center mb-2 ">
        ...
        <div className="text-muted mb-4" >
          Your bus ticket has been successfully booked.<br/> Get ready for a comfortable journey!
        </div>
      </div>
        ...
        <div className="col-md-11 col-xl-10 col-xxl-8">
          <div className={`p-0 ${style.card} p-3`}>
            ...
            <div className="row g-0 px-4 py-3">
              ...
              <div className="col-md-6">
                <div className="d-flex justify-content-end">
                  ...
                  <ViewQrCode open={qrOpen} onClose={() => setQrOpen(false)} booking={booking} />
                </div>
            ...
            <div className="border-bottom px-4 py-3">
              <div className="rows mx-auto d-flex justify-content-between align-items-center mb-3 flex-wrap">
                <span className="small mb-2">Bus Location & Route</span>
                <button className=" col-12 col-sm-auto btn btn-outline-light btn-sm border text-dark px-3" onClick={() => setShowTrack(true)}>
          ...
          <div className="text-center mt-3">
            ...
            <Link href={urls?.landing_page} className="btn btn-primary px-4 my-2" style={{ background: "#6e2faf", border: "none" }}>
